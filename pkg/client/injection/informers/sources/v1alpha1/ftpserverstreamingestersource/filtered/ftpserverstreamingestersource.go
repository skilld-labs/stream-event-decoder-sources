...
func Get(ctx context.Context, selector string) v1alpha1.SampleSourceInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/skilld-labs/stream-event-decoder-sources/pkg/client/informers/externalversions/samples/v1alpha1.SampleSourceInformer with selector %s from context.", selector)
	}
